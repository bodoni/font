    ...
    assert_eq!(
        ...
        [
            (
                ...
                "DFLT",
                vec![
                    "[[?, A, O, a, i, j, o, 15e, 15f, e0d, …, e10, e24, e26, e2c, e31, e34, …, e37, e3a, e47, e4d]]",
            ...
            (
                ...
                vec![
                    "[[e33]]",
                    "[[[[e38], [331]], [[e39], [331]]]]",
                    "[[[[e0d–e10, e24, e26], [e38–e3a]]], [?], [[[e31, e34–e37, e47–e4e], [e48–e4c]]], [[[e2c], [e31, e34–e37, e47–e4e]]], [[[e1b, e1d, e1f], [e31, e34–e37, e47–e4d]]], [?], [?], [[[e1b, e1d, e1f], [e38–e3a], [e48–e4c]]], [?], [[[e0c, e0d, e12, e13], [331]]]]",
                    "[[?]]",
    ...
    assert_eq!(
        ...
        [
            ...
            (
                ...
                "DFLT",
                vec![
                    "[[?, 627 (4), 62d (6), 631 (4), 633 (7), 635 (2), 639 (4), 643 (3), 645 (3), 647 (3), 648 (4), 649 (7), 662 (2), 663 (2), 664 (3), 666 (2), 667 (3), 668 (3), 6a1 (4)]]",
                ],
            ),
            (
                "salt",
...
fn flatten(values: &BTreeSet<Option<Sample>>) -> String {
    let mut buffer = String::new();
    buffer.push('[');
    for (index, value) in values.iter().enumerate() {
        match value {
            Some(Sample::Simple(Component::Scalar(value))) => {
                buffer.push_str(&escape(*value));
            }
            Some(Sample::Simple(Component::Range((start, end)))) => {
            ...
            Some(Sample::Alternate((value, count))) => {
                buffer.push_str(&escape(*value));
                buffer.push_str(&format!(" ({count})"));
            }
            Some(Sample::Composite(positions)) => {
                buffer.push('[');
